...
format:
  ...
  html: default
params:
  dataset: "C:\\Users\\rk422373\\Documents\\Reproducible Research\\Class 10\\RRcourse2023\\Quarto and MD 3\\4. Params\\file.csv"
  year: 2017
  region: Europe
---
...
cat("The year is ", params$year, " in ", params$region, " and the value is ", value, ".", sep="")
